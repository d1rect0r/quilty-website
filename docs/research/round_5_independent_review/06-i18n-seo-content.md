...
**Retrofit cost if wrong.** **Low**. Sitemap shape is rewriteable any session; the discipline of *having one* matters more than which pattern.
...
- **410** = Gone. Use for *intentionally retired* URLs you want deindexed fast — not the same as 404. Cite: Search Engine Land, Google's own crawl guidance.
...
- Use 410 for *intentionally retired* URLs (e.g., a sunset feature page).
