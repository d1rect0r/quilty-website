 ...
 *
 * Producer/consumer split: this file is GENERATED by Style Dictionary
 * v5 from the DTCG JSON sources at packages/tokens/tokens/. It does
 * NOT emit \`@import 'tailwindcss';\` — per the Turborepo + Tailwind v4
 * cross-package canon, the consumer app is the legitimate owner of
 * Tailwind framework imports. Apps/web/app/globals.css is the
 * consumer entry point and owns that directive.
 */
